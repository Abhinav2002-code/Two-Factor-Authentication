...
char keypad(){
    ...
    while (x == 0){
        ...
        keyrow1 = 0, keyrow2 = 1, keyrow3 = 1, keyrow4 = 1;
        if (keycolumn1 == 0){
            lcddat('*');
            delay(1000);
            x = 1;
        ...
        keyrow1 = 1, keyrow2 = 0, keyrow3 = 1, keyrow4 = 1;
        if (keycolumn1 == 0){
            lcddat('*');
            delay(1000);
            x = 1;
        ...
        keyrow1 = 1, keyrow2 = 1, keyrow3 = 0, keyrow4 = 1;
        if (keycolumn1 == 0){
            lcddat('*');
            delay(1000);
            x = 1;
        ...
        keyrow1 = 1, keyrow2 = 1, keyrow3 = 1, keyrow4 = 0;
        if (keycolumn1 == 0){
            lcddat('*');
            delay(1000);
            x = 1;
...
void check(){
    if (pin_siva[0] == Epin[0] && pin_siva[1] == Epin[1] && pin_siva[2] == Epin[2] && pin_siva[3] == Epin[3] && pin_siva[4] == Epin[4]){
        ...
        delay(2000);
          ...
          lcddat(rfid[i]);
          delay(1000);
				  if(strncmp(rfid,"yyyyyyyyyyyy",12)==0){
						motorpin1 = 1;
            motorpin2 = 0;
						delay(5000);
            lcdcmd(0xc1);
        ...
        delay(2000);
          ...
          lcddat(rfid[i]);
          delay(1000);
				  if(strncmp(rfid,"rrrrrrrrrrrr",12)==0){
						motorpin1 = 1;
            motorpin2 = 0;
						delay(5000);
            lcdcmd(0xc1);
        ...
        delay(2000);
          ...
          lcddat(rfid[i]);
          delay(1000);
				  if(strncmp(rfid,"uuuuuuuuuuuu",12)==0){
						motorpin1 = 1;
            motorpin2 = 0;
						delay(5000);
            lcdcmd(0xc1);
        ...
        delay(2000);
          ...
          lcddat(rfid[i]);
          delay(1000);
				  if(strncmp(rfid,"wwwwwwwwwwww",12)==0){
						motorpin1 = 1;
            motorpin2 = 0;
						delay(5000);
            lcdcmd(0xc1);
